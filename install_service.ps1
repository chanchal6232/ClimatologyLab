...
# -------------------------------------------------------------------
Write-Host "`n[1/4] Setting up NSSM..." -ForegroundColor Yellow
...
# -------------------------------------------------------------------
Write-Host "`n[2/4] Checking for existing service..." -ForegroundColor Yellow
...
# -------------------------------------------------------------------
Write-Host "`n[3/4] Installing Windows service..." -ForegroundColor Yellow

$pythonExe = "$ProjectDir\venv\Scripts\python.exe"
$scriptPath = "$ProjectDir\run_server.py"
...
# -------------------------------------------------------------------
Write-Host "`n[4/4] Starting the service..." -ForegroundColor Yellow
...
if ($svc.Status -eq "Running") {
    ...
    Write-Host "Debug with: $nssmExe status $ServiceName" -ForegroundColor Yellow
}
